    ...
    def server_up(self):
        ...
        while True:
            ...
            if not data:
                ...
                print(data.decode())
                message = f'{self.client_addr}: {data.decode()}\n'
                self.output_text1.insert(tk.END, message)
                conn.send(b'Hello from server!')

        server_socket.close()

    def client_connect(self):
        self.client_addr = (self.client_ip_entry.get().strip(), 12345)
